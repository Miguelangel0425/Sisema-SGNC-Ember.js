import type { INota } from '../types/INota';
import {
  EstadoNota,
  estadoNotaEsEditable,
  estadoNotaEsEliminable,
} from '../enums/EstadoNota';
import type { Cobertura } from '../enums/Cobertura';
import type { SectorBeneficiario } from '../enums/SectorBeneficiario';
import type { Director } from './Director';
import type { Departamento } from './Departamento';
import type { Carrera } from './Carrera';
import { Alineamiento } from './Alineamiento';
import type { ImpactoEsperado } from './ImpactoEsperado';
import { PoblacionBeneficiaria } from './PoblacionBeneficiaria';
import { Presupuesto } from './Presupuesto';
import type { EntidadCooperante } from './EntidadCooperante';
...
export class NotaConceptual implements INota {
  ...
  public validarFechasDentroDeConvocatoria(
    ...
    return (
      ...
      this._fechaFinPlanificada.getTime() >
        this._fechaInicioPlanificada.getTime()
    );
  }
