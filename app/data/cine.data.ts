 ...
 */
export type ICineOpcion = IOpcion;
...
export const CINE_ESPECIFICO_POR_AMPLIO: Record<string, ICineOpcion[]> = {
  ...
  "06": [
    { codigo: "061",texto: "061 Tecnologías de la información y la comunicación" },
  ],
  "07": [
...
> = {
  ...
  "002": [
    { codigo: "0021", texto: "0021 Alfabetización y aritmética elemental" },
  ],
  "003": [
    { codigo: "0031", texto: "0031 Competencias personales y desarrollo" },
  ],
  "011": [
    { codigo: "0111", texto: "0111 Ciencias de la educación" },
  ],
  "021": [
    ...
    { codigo: "0215", texto: "0215 Música y artes escénicas" },
  ],
  "022": [
    { codigo: "0221", texto: "0221 Religión y teología" },
    { codigo: "0222", texto: "0222 Historia y arqueología" },
    { codigo: "0223", texto: "0223 Filosofía y ética" },
  ],
  "023": [
    { codigo: "0231", texto: "0231 Adquisición del lenguaje" },
    { codigo: "0232", texto: "0232 Literatura y lingüística" },
  ],
  "031": [
    { codigo: "0311", texto: "0311 Economía" },
  ...
  "032": [
    { codigo: "0321", texto: "0321 Periodismo y reportajes" },
  ...
  "041": [
    ...
    { codigo: "0413", texto: "0413 Gestión y administración" },
    { codigo: "0414", texto: "0414 Mercadotecnia y publicidad" },
    { codigo: "0415", texto: "0415 Secretariado y trabajo de oficina" },
    { codigo: "0416", texto: "0416 Ventas al por mayor y al por menor" },
    { codigo: "0417", texto: "0417 Competencias laborales" },
  ],
  "042": [
  ...
  "071": [
    {codigo: "0711", texto: "0711 Ingeniería y procesos químicos" },
    { codigo: "0712", texto: "0712 Tecnología de protección del medio ambiente" },
