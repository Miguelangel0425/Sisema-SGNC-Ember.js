...
export type IOeOpcion = IOpcion;

export const OE_OBJETIVOS: IOeOpcion[] = [
  {
    codigo: 'OE1',
    texto: 'OE1. Incrementar la calidad académica y la innovación educativa',
  },
  {
    codigo: 'OE2',
    texto:
      'OE2. Incrementar la calidad, impacto y visibilidad del conocimiento científico',
  },
  {
    codigo: 'OE3',
    texto:
...
export const OE_ESTRATEGIAS: IOeOpcion[] = [
  {
    codigo: 'a',
    texto: 'a. Identificar actores clave y alianzas estratégicas',
  },
  { codigo: 'b', texto: 'b. Difundir cultura institucional y Ethos Militar' },
  {
    codigo: 'c',
    texto: 'c. Internacionalizar docencia, investigación y vinculación',
  },
  {
    codigo: 'd',
    texto: 'd. Desarrollar capacitación continua en áreas estratégicas',
  },
  { codigo: 'e', texto: 'e. Diversificar fuentes de financiamiento' },
  {
    codigo: 'f',
    texto:
      'f. Fortalecer innovación social, abierta y transferencia tecnológica',
  },
  {
    codigo: 'g',
    texto:
      'g. Fortalecer educación continua, posgrado y servicios especializados',
  },
];
